...
Go here:  
https://github.com/angall1/CSVMusic/releases/tag/v1.2.5  

Download one of the following based on your OS:

### Windows
https://github.com/angall1/CSVMusic/releases/download/v1.2.5/CSVMusic-windows.zip  

### macOS
https://github.com/angall1/CSVMusic/releases/download/v1.2.5/CSVMusic-macos.zip  

### Linux
https://github.com/angall1/CSVMusic/releases/download/v1.2.5/CSVMusic-linux.zip  
